...
<style>
:root{--ink:#ECEAE3;--sub:#8b919b;--line:#1f2329;--bg:#0a0b0d;--card:#101317;--accent:#c6a063}
...
.t.on{border-color:var(--accent);background:#15241d}
...
input.tx{width:100%;border:1px solid var(--line);border-radius:10px;padding:11px 12px;font-size:14px;background:#161a20;color:var(--ink)}
.save{margin-top:22px;width:100%;background:var(--accent);color:#0a0b0d;border:0;border-radius:12px;padding:14px;font-size:16px;font-weight:800;cursor:pointer}
